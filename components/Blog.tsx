        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Insights for <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-emerald-900">Engineering Leaders</span>
            </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="bg-[#0b0b0b] p-8 md:p-12 flex flex-col justify-center">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="px-3 py-1 bg-sky-600/10 text-sky-500 text-xs font-bold rounded-full uppercase tracking-wider border border-sky-600/20">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 group-hover:text-sky-500 transition-colors">
                    {featuredPost.title}
                  </h2>
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <Button variant="ghost" className="!p-0 hover:!bg-transparent text-sky-500 hover:text-sky-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {regularPosts.map((post, idx) => (
              <motion.div
                ...
                className="bg-[#0b0b0b] border border-white/5 rounded-2xl overflow-hidden group hover:border-cyan-600/30 transition-all flex flex-col"
              >
          ...
          <div className="bg-gradient-to-r from-[#0b0b0b] to-[#111] border border-white/10 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
             <div className="absolute top-0 right-0 w-64 h-64 bg-sky-600/5 rounded-full blur-[80px]"></div>
             <div className="relative z-10 max-w-xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input 
                    ...
                    className="flex-1 bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-sky-500 transition-colors"
                  />
